 ...
 * pur via `tsx`) lit directement le référentiel JSON local (même source que `import-catalog.ts`, donc
...
/** Charge les monstres et les donjons du référentiel JSON local et reconstruit les mêmes index que
 ...
 * motivé cette dernière — mêmes données de toute façon (le référentiel local est la source des
