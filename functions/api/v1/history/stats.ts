 ...
 *
 * Onze `SELECT` indépendants (pas de transaction requise, driver `neon-http` déjà sans
...
function emptyGroupTotals(): GroupTotalsRow {
  return { fights: 0, won: 0, lost: 0, kamasGained: 0, xpGained: 0, xpByCharacter: [], loot: [] };
}
