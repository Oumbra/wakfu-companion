...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  fr: {
    ...
    'tracker.countdownProgressTooltip': '{{percent}}% de la cible atteints',
  ...
  en: {
    ...
    'tracker.countdownProgressTooltip': '{{percent}}% of target reached',
  ...
  es: {
    ...
    'tracker.countdownProgressTooltip': '{{percent}}% del objetivo alcanzado',
  ...
  pt: {
    ...
    'tracker.countdownProgressTooltip': '{{percent}}% da meta atingidos',
