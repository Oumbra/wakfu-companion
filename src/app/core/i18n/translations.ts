...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  fr: {
    ...
    'profile.dashboardLayout.slot.histCombats': 'Historique combats',
  ...
  en: {
    ...
    'profile.dashboardLayout.slot.combat': 'Combat',
    'profile.dashboardLayout.slot.histCombats': 'Combat history',
  ...
  es: {
    ...
    'profile.dashboardLayout.slot.histCombats': 'Historial de combates',
  ...
  pt: {
    ...
    'profile.dashboardLayout.slot.kpi': 'Objetivos',
    'profile.dashboardLayout.slot.combat': 'Combate',
    'profile.dashboardLayout.slot.histCombats': 'Histórico de combates',
    'profile.dashboardLayout.slot.purchases': 'Compras',
