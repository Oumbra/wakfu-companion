...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  fr: {
    ...
    'tracker.bulkDeleteStart': 'Supprimer plusieurs',
    ...
    'footer.copyright': '© Wakfu Companion — projet de fan non affilié à Ankama',
    'footer.privacy': 'Confidentialité',
    'footer.terms': "Conditions d'utilisation",
    'footer.notice': 'Mentions légales',
    'legal.privacy.title': 'Confidentialité',
    'legal.privacy.body':
      "Wakfu Companion fonctionne entièrement dans votre navigateur : il n'y a aucun serveur, aucun compte et aucune collecte de données.\n\nLecture du fichier wakfu.log : avec le bouton de connexion, l'application lit votre fichier de log directement sur votre disque via l'API File System Access de votre navigateur. Son contenu n'est jamais envoyé où que ce soit — il reste sur votre appareil et n'est traité que localement pour calculer dégâts, butin, XP, kamas et historique de combats.\n\nDonnées enregistrées : le suivi d'objets/ennemis, les alertes sonores, votre profil (pseudo, avatar, roster de personnages) et vos réglages sont stockés uniquement sur votre appareil (stockage local du navigateur), jamais transmis à un serveur. Vous pouvez les exporter/importer manuellement (fichier JSON) ou tout réinitialiser à tout moment depuis l'application.\n\nVersion autonome (fichier .html) : ouverte en double-clic sans serveur, elle fonctionne exactement de la même façon.\n\nRessources externes : les icônes d'objets et de monstres sont chargées depuis des CDN tiers communautaires (vertylo.github.io, cdn.wakfuli.com) ou officiels (static.ankama.com) — comme pour n'importe quelle image chargée sur le web, ces services peuvent voir votre adresse IP au moment du chargement. Aucune autre donnée ne leur est transmise.\n\nAucun cookie, aucun outil d'analyse d'audience, aucune publicité.",
    'legal.terms.title': "Conditions d'utilisation",
    'legal.terms.body':
      'Wakfu Companion est un outil gratuit réalisé par un joueur, non affilié à Ankama, à l\'éditeur du jeu Wakfu ni à aucune société tierce. "Wakfu", son univers et les éléments de jeu qu\'il représente (objets, monstres, sorts...) sont la propriété d\'Ankama.\n\nL\'application se contente de LIRE votre fichier wakfu.log en local pour en extraire et afficher des statistiques ; elle n\'écrit jamais dans ce fichier et n\'interagit à aucun moment avec le jeu ni avec les serveurs d\'Ankama. Son usage ne devrait donc avoir aucun impact sur votre compte ou votre partie, mais elle est fournie "telle quelle", sans garantie d\'aucune sorte : à utiliser à vos risques.\n\nLe suivi en direct nécessite un navigateur compatible avec l\'API File System Access (Chrome, Edge et la plupart des navigateurs à base de Chromium) ; le fichier HTML autonome, lui, s\'ouvre dans n\'importe quel navigateur mais requiert la même API pour le suivi en direct.\n\nLes référentiels d\'objets, monstres et recettes intégrés proviennent de données publiques du jeu et de projets communautaires tiers ; ils peuvent être incomplets ou obsolètes après une mise à jour du jeu.\n\nCes conditions peuvent évoluer avec les futures versions de l\'application.',
    'legal.notice.title': 'Mentions légales',
    'legal.notice.body':
      "Éditeur : Oumbra, développeur indépendant — projet personnel à but non lucratif.\nContact : via les issues du dépôt GitHub github.com/oumbra/wakfu-companion.\n\nHébergement : Wakfu Companion est distribué avant tout comme un fichier HTML autonome (wakfu-companion.standalone.html) exécuté localement dans votre navigateur, sans aucun hébergeur impliqué. Si vous y accédez via une adresse web, celle-ci est hébergée par une plateforme d'hébergement statique standard, sans base de données ni traitement serveur.\n\nPropriété intellectuelle : \"Wakfu\" et l'ensemble des éléments du jeu (noms, images, univers) sont la propriété d'Ankama Games. Wakfu Companion n'est ni édité, ni hébergé, ni approuvé par Ankama et n'entretient aucun lien avec cette société. Les icônes d'objets et de monstres affichées proviennent de projets communautaires tiers (voir wakassets) et des serveurs officiels du jeu, utilisées à titre purement illustratif et non commercial.\n\nCode source : ce projet est disponible sur GitHub à l'adresse github.com/oumbra/wakfu-companion.",
  },
  en: {
    ...
    'tracker.bulkDeleteStart': 'Delete several',
    ...
    'footer.copyright': '© Wakfu Companion — fan project, not affiliated with Ankama',
    'footer.privacy': 'Privacy',
    'footer.terms': 'Terms of use',
    'footer.notice': 'Legal notice',
    'legal.privacy.title': 'Privacy',
    'legal.privacy.body':
      "Wakfu Companion runs entirely in your browser: there is no server, no account, and no data collection.\n\nReading wakfu.log: once you connect, the app reads your log file directly from your disk using your browser's File System Access API. Its content is never sent anywhere — it stays on your device and is only processed locally to compute damage, loot, XP, kamas, and fight history.\n\nStored data: item/enemy tracking, sound alerts, your profile (nickname, avatar, character roster) and your settings are stored only on your device (browser local storage), never sent to a server. You can export/import them manually (JSON file) or reset everything at any time from the app.\n\nStandalone version (.html file): opened by double-clicking with no server involved, it works exactly the same way.\n\nExternal resources: item and monster icons are loaded from third-party community CDNs (vertylo.github.io, cdn.wakfuli.com) or official ones (static.ankama.com) — like any image loaded on the web, these services may see your IP address when loading them. No other data is sent to them.\n\nNo cookies, no analytics tools, no ads.",
    'legal.terms.title': 'Terms of use',
    'legal.terms.body':
      'Wakfu Companion is a free tool made by a player, not affiliated with Ankama, the publisher of Wakfu, or any third-party company. "Wakfu", its universe, and the game elements it represents (items, monsters, spells...) are the property of Ankama.\n\nThe app only READS your wakfu.log file locally to extract and display statistics; it never writes to that file and never interacts with the game or with Ankama\'s servers in any way. Using it should therefore have no impact on your account or your game, but it is provided "as is", without any warranty: use at your own risk.\n\nLive tracking requires a browser that supports the File System Access API (Chrome, Edge, and most Chromium-based browsers); the standalone HTML file opens in any browser but needs the same API for live tracking.\n\nThe built-in item, monster, and recipe references come from public game data and third-party community projects; they may be incomplete or outdated after a game update.\n\nThese terms may change with future versions of the app.',
    'legal.notice.title': 'Legal notice',
    'legal.notice.body':
      "Publisher: Oumbra, independent developer — personal, non-commercial project.\nContact: via the GitHub repository issues at github.com/oumbra/wakfu-companion.\n\nHosting: Wakfu Companion is primarily distributed as a standalone HTML file (wakfu-companion.standalone.html) run locally in your browser, with no hosting provider involved. If you access it via a web address, it is hosted on a standard static hosting platform, with no database or server-side processing.\n\nIntellectual property: \"Wakfu\" and all game elements (names, images, universe) are the property of Ankama Games. Wakfu Companion is neither published, hosted, nor endorsed by Ankama and has no affiliation with that company. The item and monster icons shown come from third-party community projects (see wakassets) and the game's official servers, used purely for illustrative, non-commercial purposes.\n\nSource code: this project is available on GitHub at github.com/oumbra/wakfu-companion.",
  },
  es: {
    ...
    'tracker.bulkDeleteStart': 'Eliminar varios',
    ...
    'footer.copyright': '© Wakfu Companion — proyecto de fan no afiliado a Ankama',
    'footer.privacy': 'Privacidad',
    'footer.terms': 'Condiciones de uso',
    'footer.notice': 'Aviso legal',
    'legal.privacy.title': 'Privacidad',
    'legal.privacy.body':
      'Wakfu Companion funciona por completo en tu navegador: no hay servidor, ni cuenta, ni recopilación de datos.\n\nLectura de wakfu.log: al conectar, la aplicación lee tu archivo de registro directamente desde tu disco mediante la API File System Access de tu navegador. Su contenido nunca se envía a ningún sitio: permanece en tu dispositivo y solo se procesa localmente para calcular daño, botín, XP, kamas e historial de combates.\n\nDatos guardados: el seguimiento de objetos/enemigos, las alertas sonoras, tu perfil (apodo, avatar, lista de personajes) y tus ajustes se guardan únicamente en tu dispositivo (almacenamiento local del navegador), nunca se envían a un servidor. Puedes exportarlos/importarlos manualmente (archivo JSON) o reiniciarlo todo en cualquier momento desde la aplicación.\n\nVersión independiente (archivo .html): abierta con doble clic sin ningún servidor, funciona exactamente igual.\n\nRecursos externos: los iconos de objetos y monstruos se cargan desde CDN comunitarios de terceros (vertylo.github.io, cdn.wakfuli.com) u oficiales (static.ankama.com) — como con cualquier imagen cargada en la web, estos servicios pueden ver tu dirección IP al cargarlas. No se les transmite ningún otro dato.\n\nSin cookies, sin herramientas de análisis de audiencia, sin publicidad.',
    'legal.terms.title': 'Condiciones de uso',
    'legal.terms.body':
      'Wakfu Companion es una herramienta gratuita hecha por un jugador, no afiliada a Ankama, al editor de Wakfu ni a ninguna empresa externa. "Wakfu", su universo y los elementos de juego que representa (objetos, monstruos, hechizos...) son propiedad de Ankama.\n\nLa aplicación se limita a LEER tu archivo wakfu.log de forma local para extraer y mostrar estadísticas; nunca escribe en ese archivo ni interactúa en ningún momento con el juego ni con los servidores de Ankama. Su uso no debería tener ningún impacto en tu cuenta ni en tu partida, pero se ofrece "tal cual", sin garantía de ningún tipo: úsala bajo tu propia responsabilidad.\n\nEl seguimiento en directo requiere un navegador compatible con la API File System Access (Chrome, Edge y la mayoría de navegadores basados en Chromium); el archivo HTML independiente se abre en cualquier navegador, pero necesita la misma API para el seguimiento en directo.\n\nLos catálogos de objetos, monstruos y recetas incluidos proceden de datos públicos del juego y de proyectos comunitarios de terceros; pueden estar incompletos u obsoletos tras una actualización del juego.\n\nEstas condiciones pueden cambiar con futuras versiones de la aplicación.',
    'legal.notice.title': 'Aviso legal',
    'legal.notice.body':
      'Editor: Oumbra, desarrollador independiente — proyecto personal sin ánimo de lucro.\nContacto: a través de las incidencias (issues) del repositorio de GitHub github.com/oumbra/wakfu-companion.\n\nAlojamiento: Wakfu Companion se distribuye principalmente como un archivo HTML independiente (wakfu-companion.standalone.html) que se ejecuta localmente en tu navegador, sin ningún proveedor de alojamiento implicado. Si accedes a través de una dirección web, esta está alojada en una plataforma de alojamiento estático estándar, sin base de datos ni procesamiento en servidor.\n\nPropiedad intelectual: "Wakfu" y todos los elementos del juego (nombres, imágenes, universo) son propiedad de Ankama Games. Wakfu Companion no está editado, alojado ni respaldado por Ankama y no tiene ninguna relación con dicha empresa. Los iconos de objetos y monstruos mostrados proceden de proyectos comunitarios de terceros (ver wakassets) y de los servidores oficiales del juego, usados con fines puramente ilustrativos y no comerciales.\n\nCódigo fuente: este proyecto está disponible en GitHub en github.com/oumbra/wakfu-companion.',
  },
  pt: {
    ...
    'footer.copyright': '© Wakfu Companion — projeto de fã não afiliado à Ankama',
    'footer.privacy': 'Privacidade',
    'footer.terms': 'Termos de uso',
    'footer.notice': 'Aviso legal',
    'legal.privacy.title': 'Privacidade',
    'legal.privacy.body':
      'O Wakfu Companion funciona inteiramente no seu navegador: não há servidor, conta ou coleta de dados.\n\nLeitura do wakfu.log: ao conectar, o aplicativo lê seu arquivo de log diretamente do seu disco usando a API File System Access do seu navegador. Seu conteúdo nunca é enviado a lugar nenhum — permanece no seu dispositivo e só é processado localmente para calcular dano, butim, XP, kamas e histórico de combates.\n\nDados armazenados: o acompanhamento de itens/inimigos, os alertas sonoros, seu perfil (apelido, avatar, lista de personagens) e suas configurações são armazenados apenas no seu dispositivo (armazenamento local do navegador), nunca enviados a um servidor. Você pode exportá-los/importá-los manualmente (arquivo JSON) ou reiniciar tudo a qualquer momento pelo aplicativo.\n\nVersão autônoma (arquivo .html): aberta com um duplo clique sem nenhum servidor envolvido, funciona exatamente da mesma forma.\n\nRecursos externos: os ícones de itens e monstros são carregados de CDNs comunitários de terceiros (vertylo.github.io, cdn.wakfuli.com) ou oficiais (static.ankama.com) — como qualquer imagem carregada na web, esses serviços podem ver seu endereço IP ao carregá-las. Nenhum outro dado é transmitido a eles.\n\nSem cookies, sem ferramentas de análise de audiência, sem publicidade.',
    'legal.terms.title': 'Termos de uso',
    'legal.terms.body':
      'O Wakfu Companion é uma ferramenta gratuita feita por um jogador, não afiliada à Ankama, à editora de Wakfu ou a qualquer empresa terceira. "Wakfu", seu universo e os elementos de jogo que representa (itens, monstros, feitiços...) são propriedade da Ankama.\n\nO aplicativo apenas LÊ seu arquivo wakfu.log localmente para extrair e exibir estatísticas; ele nunca escreve nesse arquivo e nunca interage, em momento algum, com o jogo ou com os servidores da Ankama. Seu uso não deveria, portanto, ter nenhum impacto na sua conta ou na sua partida, mas é fornecido "como está", sem garantia de qualquer tipo: use por sua conta e risco.\n\nO acompanhamento ao vivo requer um navegador compatível com a API File System Access (Chrome, Edge e a maioria dos navegadores baseados em Chromium); o arquivo HTML autônomo abre em qualquer navegador, mas precisa da mesma API para o acompanhamento ao vivo.\n\nOs catálogos de itens, monstros e receitas incluídos vêm de dados públicos do jogo e de projetos comunitários de terceiros; podem estar incompletos ou desatualizados após uma atualização do jogo.\n\nEstes termos podem mudar com futuras versões do aplicativo.',
    'legal.notice.title': 'Aviso legal',
    'legal.notice.body':
      'Editor: Oumbra, desenvolvedor independente — projeto pessoal sem fins lucrativos.\nContato: pelas issues do repositório GitHub github.com/oumbra/wakfu-companion.\n\nHospedagem: o Wakfu Companion é distribuído principalmente como um arquivo HTML autônomo (wakfu-companion.standalone.html) executado localmente no seu navegador, sem nenhum provedor de hospedagem envolvido. Se você acessar por um endereço web, ele está hospedado em uma plataforma de hospedagem estática padrão, sem banco de dados ou processamento no servidor.\n\nPropriedade intelectual: "Wakfu" e todos os elementos do jogo (nomes, imagens, universo) são propriedade da Ankama Games. O Wakfu Companion não é editado, hospedado nem endossado pela Ankama e não possui nenhuma relação com essa empresa. Os ícones de itens e monstros exibidos vêm de projetos comunitários de terceiros (veja wakassets) e dos servidores oficiais do jogo, usados puramente para fins ilustrativos e não comerciais.\n\nCódigo-fonte: este projeto está disponível no GitHub em github.com/oumbra/wakfu-companion.',
  },
};
