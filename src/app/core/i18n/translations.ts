...
export const TRANSLATIONS: Record<AppLocale, Record<string, string>> = {
  fr: {
    ...
    'profile.rosterLabel': 'Personnages déclarés',
  ...
  en: {
    ...
    'profile.rosterLabel': 'Declared characters',
  ...
  es: {
    ...
    'profile.rosterLabel': 'Personajes declarados',
  ...
  pt: {
    ...
    'profile.rosterLabel': 'Personagens declarados',
