 ...
 * deux variantes coexistent dans un même fichier, vérifié sur le fichier de référence Anonyme-Eniripsa2,
 ...
 * `wakfu.log` d'Anonyme-Eniripsa2) : la majorité des MONSTRES RÉELS d'un combat (jusqu'à 61% des lignes
...
export class LogParser {
   ...
   * réinstancie une invocation déjà connue via sa propre annonce Invoque" (ex. fichier Anonyme-Eniripsa2,
