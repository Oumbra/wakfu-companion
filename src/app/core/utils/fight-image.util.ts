 ...
 *    le référentiel, voir CatalogService.findWakfuUltimateBreachByBossMonsters) ->
 ...
 *    dont il est le boss (`bossMonsterId` du référentiel), ou à défaut (aucun donjon
 ...
 * générique de repli DEFAULT_FIGHT_IMAGE_URL côté référentiel) mais
